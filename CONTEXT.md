...
This context describes the language of a minimal chat application that groups conversations into workspaces, streams assistant replies, and updates conversation titles from the first user prompt. It exists so product and implementation discussions use the same terms for workspace settings, chat history, titles, and stream lifecycle.
...
- **Workspace Settings** currently govern only model choice, model-specific settings, and system message
...
>
> **Dev:** "Does **Workspace Settings** already include other future features such as document-library retrieval settings?"
> **Domain expert:** "No — for now, **Workspace Settings** only govern model choice, model-specific settings, and the system message."
>
...
- "workspace settings scope" was unclear — resolved: **Workspace Settings** currently govern only model choice, model-specific settings, and system message.
